    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item "><a href="{{route('album')}}">Альбом</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('album.update',$album->id)}}" method="post" class="col-4" enctype="multipart/form-data">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-group w-50">
                                ...
                                <div class="w25">
                                    <img src="{{asset('storage/'. $album->main_image)}}" alt="{{$album->title}}"
                                         class="w-50 my-3">
                                </div>
