;(function (global, factory) {
    ...
    hooks.defineLocale('cs', {
        ...
        calendar: {
            sameDay: '[dnes main] LT',
            nextDay: '[zítra main] LT',
            nextWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[main neděli main] LT';
                    case 1:
                    case 2:
                        return '[main] dddd [main] LT';
                    case 3:
                        return '[ve středu main] LT';
                    case 4:
                        return '[ve čtvrtek main] LT';
                    case 5:
                        return '[main pátek main] LT';
                    case 6:
                        return '[main sobotu main] LT';
                }
            },
            lastDay: '[včera main] LT',
            lastWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[minulou neděli main] LT';
                    case 1:
                    case 2:
                        return '[minulé] dddd [main] LT';
                    case 3:
                        return '[minulou středu main] LT';
                    case 4:
                    case 5:
                        return '[minulý] dddd [main] LT';
                    case 6:
                        return '[minulou sobotu main] LT';
                }
            },
            sameElse: 'L',
        },
    ...
    hooks.defineLocale('sk', {
        ...
        calendar: {
            ...
            nextWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[main nedeľu o] LT';
                    case 1:
                    case 2:
                        return '[main] dddd [o] LT';
                    case 3:
                        return '[main stredu o] LT';
                    case 4:
                        return '[vo štvrtok o] LT';
                    case 5:
                        return '[main piatok o] LT';
                    case 6:
                        return '[main sobotu o] LT';
                }
            },
            lastDay: '[včera o] LT',
            lastWeek: function () {
    ...
    hooks.defineLocale('sl', {
        ...
        calendar: {
            ...
            nextWeek: function () {
                switch (this.day()) {
                    case 0:
                        return '[main] [nedeljo] [ob] LT';
                    case 3:
                        return '[main] [sredo] [ob] LT';
                    case 6:
                        return '[main] [soboto] [ob] LT';
                    case 1:
                    case 2:
                    case 4:
                    case 5:
                        return '[main] dddd [ob] LT';
                }
            },
